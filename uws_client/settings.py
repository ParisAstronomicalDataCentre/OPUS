...
OIDC_IDP_URL = "https://<openid-server>/.well-known/openid-configuration"  # to be defined in settings_local.py
OIDC_SCOPE = 'openid email profile'
OIDC_CLIENT_ID = ""      # to be generated by Identity Provider, and defined in settings_local.py
OIDC_CLIENT_SECRET = ""  # to be generated by Identity Provider, and defined in settings_local.py
