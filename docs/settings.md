...
| WSGI_THREADS | Number of threads handling the requests in parallel, for the server and for the client (default: 10). A request waiting for a job phase change (`WAIT`) holds a thread. |
